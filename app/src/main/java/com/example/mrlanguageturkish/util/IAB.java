package com.example.mrlanguageturkish.util;
...
import com.example.mrlanguageturkish.util.communication.BillingSupportCommunication;
import com.example.mrlanguageturkish.util.communication.OnConnectListener;

import org.json.JSONException;

import static com.example.mrlanguageturkish.util.IabHelper.BILLING_RESPONSE_RESULT_OK;
import static com.example.mrlanguageturkish.util.IabHelper.IABHELPER_BAD_RESPONSE;
import static com.example.mrlanguageturkish.util.IabHelper.IABHELPER_UNKNOWN_ERROR;
import static com.example.mrlanguageturkish.util.IabHelper.IABHELPER_UNKNOWN_PURCHASE_RESPONSE;
import static com.example.mrlanguageturkish.util.IabHelper.IABHELPER_USER_CANCELLED;
import static com.example.mrlanguageturkish.util.IabHelper.IABHELPER_VERIFICATION_FAILED;
import static com.example.mrlanguageturkish.util.IabHelper.RESPONSE_CODE;
import static com.example.mrlanguageturkish.util.IabHelper.RESPONSE_INAPP_PURCHASE_DATA;
import static com.example.mrlanguageturkish.util.IabHelper.RESPONSE_INAPP_SIGNATURE;
import static com.example.mrlanguageturkish.util.IabHelper.getResponseDesc;
